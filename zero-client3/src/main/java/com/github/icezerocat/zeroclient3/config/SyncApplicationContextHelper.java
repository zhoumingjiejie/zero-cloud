 ...
 */
@Component
public class SyncApplicationContextHelper implements ApplicationContextAware {
    private static ApplicationContext applicationContext;
    private static Logger log = LoggerFactory.getLogger(SyncApplicationContextHelper.class);

    @Override
    public void setApplicationContext(@NonNull ApplicationContext applicationContext) throws BeansException {
        SyncApplicationContextHelper.applicationContext = applicationContext;
    }
