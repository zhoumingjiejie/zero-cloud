package com.github.icezerocat.component.jdbctemplate.service;
...
public interface BaseJdbcTemplate extends JdbcOperations {
     ...
     * @return insert-sql
     */
    String getInsertSql(Class<?> tClass);
     ...
     */
    BaseJdbcTemplateImpl.TableCheck containsKey(Class<?> cls, Object entity);
}
