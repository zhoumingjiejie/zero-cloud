 ...
 * CreateDate:  2020/12/21 10:53
 *
 * @author zero
 * @version 1.0
 */
@Component
public class RedisApplicationContextHelper implements ApplicationContextAware {
    private static ApplicationContext applicationContext;
    private static Logger log = LoggerFactory.getLogger(RedisApplicationContextHelper.class);

    @Override
    public void setApplicationContext(@NonNull ApplicationContext applicationContext) throws BeansException {
        RedisApplicationContextHelper.applicationContext = applicationContext;
    }
    ...
    public static <T> T getTBean(String name) {
